    ...
    <div class="cv cv-1 d-flex col ms-4">
        <div class="left bg-indigo p-4 text-white">
            <div class="about mb-5">
                ...
                <h1 class="firstname mt-2">Prénom</h1>
                <h1 class="name">NOM</h1>
                <p class="work">Posté occupé</p>
            </div>
                ...
                <div class="formation-list">
                    <div class="formation-one">
                        <div class="graduation">
                            ...
                            <p class="college">Université ou école</p>
                            <p class="date">20XX - 20XX</p>
                        </div>
                    </div>
            ...
            <div class="languages mb-5">
                ...
                <div class="languages-list">
                    <div class="language-one d-flex justify-content-start mb-2">
                        ...
                        <p class="language-with-stage mb-0 ms-3">Français : Bilingue</p>
                    </div>
                    <div class="language-two d-flex justify-content-start">
                        <svg class='icon check-icon' viewBox="0 0 512 512">
                            <path d="M173.898 439.404l-166.4-166.4c-9.997-9.997-9.997-26.206 0-36.204l36.203-36.204c9.997-9.998 26.207-9.998 36.204 0L192 312.69 432.095 72.596c9.997-9.997 26.207-9.997 36.204 0l36.203 36.204c9.997 9.997 9.997 26.206 0 36.204l-294.4 294.401c-9.998 9.997-26.207 9.997-36.204-.001z"/>
                        </svg>
                        <p class="language-with-stage mb-0 ms-3">Anglais: Courant</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="experiences mb-5">
                ...
                <div class="experiences-list">
                    <div class="experience-one">
                        <h4 class="company-name">NOM DE L'ENTREPRISE | Poste occupé</h4>
                        <p class="date">Sept. 20XX - Juil. 20XX</p>
                        <div class="task">
                            <p>
