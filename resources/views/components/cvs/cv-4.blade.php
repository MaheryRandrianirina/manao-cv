...
<div class="cv cv-4 col ms-4 p-2" aria-link="/cv/4">
    ...
    <div class="cv-top about bg-white w-100 text-center position-relative pt-4">
        <h2 aria-input-number="2" class="name mt-2">
            <span id="input" aria-name="firstname">{{ isset($cv) ? $cv->firstname : "PRENOM" }}</span> <span id="input" aria-name="name">{{ isset($cv) ? $cv->name : "NOM" }}</span>
        </h2>
        <p id="input" aria-name="work" class="work text-uppercase fw-lighter">{{ isset($cv) ? $cv->current_work : "POSTE UCCUPE" }}</p>
    </div>
    <div class="d-flex cv-bottom">
        <div class="left bg-white text-white ps-4 pe-4 pb-4">
            ...
            <div class="contact mb-5 text-black">
                ...
                <div class="contact-list">
                    ...
                    <div class="email-adress d-flex justify-content-start mb-2">
                        ...
                        <p id="input" aria-name="email" aria-type="email" class="mb-0 ms-3">{{ isset($cv) ? $cv->contact->email : "Email" }}</p>
                    </div>
                    <div class="phone-number d-flex justify-content-start mb-2">
                        ...
                        <p id="input" aria-name="phone_number" aria-type="number" class="mb-0 ms-3">{{ isset($cv) ? NumberFormatter::phone("0" . $cv->contact->phone_number) : "Téléphone" }}</p>
                    </div>
            ...
            <div class="skills text-black">
                ...
                <div class="skills-list list customizable-list">
                    ...
                    <div class="skill skill-one">
                        ...
                        <p id="skill_level" class="level bar-level bg-gray"></p>
                    </div>
        ...
        <div class="right bg-white ps-4 pe-4" style="width: 60%">
            <div class="profil mb-5">
                <h3 class='mb-3'>PROFIL</h3>
                <p id="textarea" aria-name="profile_description">Lorem ipsum dolor sit, amet consectetur adipisicing elit.</p>
            </div>
            <div class="experiences mb-5">
                ...
                <div class="experiences-list list customizable-list">
                    @if(isset($cv))
                        ...
                        @foreach($cv->experiences as $experience)
                            ...
                            <div class="experience experience-{{ $stringNumber[$i] }}">
                                <h4 aria-input-number="2" class="company-name">
                                    <span id="input" aria-name="company_work_{{ $stringNumber[$i] }}">{{ $experience->work }}</span> <span id="separator">|</span> <span id="input" aria-name="company_name_{{ $stringNumber[$i] }}">{{ $experience->entreprise_name }}</span>
                                </h4>
                    ...
                    <div class="experience experience-two">
                        <h4 class="company-name">Poste occupé | <span>Nom de l'entreprise</span></h4>
                        <p class="date text-gray">Nov. 20XX - Juil. 20XX</p>
                        <ul class="task list customizable-list">
                        ...
                        <div class="degree">
                            ...
                            <p aria-input-number="2" class="date-and-college text-gray">
                                <span aria-input-number="2">
                                    ...
                                    <span id="separator">-</span> 
                                    <span id="input" aria-name="year_end_formation_one" aria-type="date">20XX</span>
                                </span> 
                                <span id="separator">|</span> 
                        ...
                        <div class="degree">
                            ...
                            <p class="date-and-college text-gray">
                                <span aria-input-number="2">
                                    ...
                                    <span id="separator">-</span> 
                                    <span id="input" aria-name="year_end_formation_two" aria-type="date">20XX</span>
                                </span> 
                                <span id="separator">|</span> 
                                <span class="etablissement" id="input" aria-name="etablissement_one">Université ou école</span>
                            </p>
