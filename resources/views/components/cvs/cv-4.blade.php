...
<div class="cv cv-4 col ms-4 p-2" aria-link="/cv/4">
    ...
    <div class="cv-top anout bg-white w-100 text-center position-relative pt-4" style="height: 150px">
        ...
        <p id="input" aria-name="work" class="work text-uppercase fw-lighter">Poste occupé</p>
    </div>
    <div class="d-flex cv-bottom">
        <div class="left bg-white text-white ps-4 pe-4">
            <div class="profile-photo mb-5">
                <svg id="input" aria-type="file" aria-name="profile_photo" class="profile-photo user bg-secondary d-block mt-0 mb-0 ms-auto me-auto" style="width: 200px; height:200px;" viewBox="0 0 448 512">
            ...
            <div class="contact mb-5 text-black">
                ...
                <div class="contact-list">
                    ...
                    <div class="email-adress d-flex justify-content-start mb-2">
                        ...
                        <p id="input" aria-name="email" aria-type="email" class="mb-0 ms-3">Adresse email</p>
                    </div>
                    <div class="phone-number d-flex justify-content-start mb-2">
                        ...
                        <p id="input" aria-name="phone_number" aria-type="number" class="mb-0 ms-3">Téléphone</p>
                    </div>
            ...
            <div class="languages mb-5 text-black">
                ...
                <div class="languages-list list customizable-list">
                    <div class="language-one">
                        <p aria-input-number="2" class="language-with-stage mb-0 ms-0 d-inline-block">
