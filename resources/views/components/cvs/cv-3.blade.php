...
<div class="cv cv-3 d-flex col ms-4">
    <div class="left p-4 bg-secondary text-white">
        ...
        <div class="skills mb-5 text-black">
            ...
            <div class="skills-list">
                <div class="skill-one">
                    <p class="skill-name">Pack Office</p>
                </div>
                <div class="skill-two">
                    <p class="skill-name">Photoshop</p>
                </div>
                <div class="skill-three">
                    <p class="skill-name">Compétence</p>
                </div>
        ...
        <div class="hobbies mb-5 text-black">
            ...
            <div class="hobbies-list">
                <div class="hobby-one d-flex justify-content-start mb-2">
                    <p class="hobby mb-0">Intérêt : XXX</p>
                </div>
        ...
        <div class="experiences mb-5">
            ...
            <div class="experiences-list">
                <div class="experience-one">
                    <h4 class="work">Poste occupé</h4>
                    <h4 class="company-name">Nom de l'entreprise</h4>
                    <p class="date">Nov. 20XX - Juil. 20XX</p>
                    <ul class="task">
                        <li class="task-one">
            ...
            <div class="formation-list">
                <div class="formation-one">
                    <div class="graduation">
                        ...
                        <p class="college">Université ou école : <span class="date">20XX - 20XX</span></p>
                    </div>
                </div>
