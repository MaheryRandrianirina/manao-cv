...
<div class="cv cv-3 d-flex col" aria-link="/cv/3">
    ...
    <div class="left p-4 bg-secondary text-white">
        <div class="profile-photo mt-5 mb-5 text-center">
            <svg id="input" aria-type="file" aria-name="profile_photo" class="user profile-photo bg-secondary d-block mt-0 mb-0 ms-auto me-auto" style="width: 150px; height:150px; border-radius: 50%" viewBox="0 0 448 512">
        ...
        <div class="contact mb-5 text-black">
            ...
            <div class="contact-list">
                <div class="phone-number d-flex justify-content-start">
                    ...
                    <p id="input" aria-name="phone_number" class="mb-0 ms-3">Téléphone</p>
                </div>
        ...
        <div class="languages mb-5 text-black">
            ...
            <div class="languages-list list customizable-list">
                <div class="language language-one">
                    ...
                    <p id="language_level" class="level bar-level bg-primary d-inline-block mb-0" style="width: 47%"></p>
                </div>
                <div class="language language-two">
                    ...
                    <p id="language_level" class="level bar-level bg-primary d-inline-block mb-0" style="width:40%"></p>
                </div>
                <div class="language language-three">
                    ...
                    <p id="language_level" class="level bar-level bg-primary d-inline-block mb-0" style="width:30%"></p>
                </div>
            </div>
        </div>
    ...
    <div class="right bg-white p-5">
        <div class="about float-end mb-5">
            <h2 aria-input-number="2" class="name">
                <span id="input" aria-name="firstname">Prénom</span>
                <span id="input" aria-name="name">Nom</span>
            </h2>
            <h3 id="input" aria-name="work" class="work">POSTE / STAGE</h3>
        </div>
